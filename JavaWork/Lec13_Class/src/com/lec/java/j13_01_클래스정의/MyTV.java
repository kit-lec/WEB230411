...
/*
  ...
  일반적으로
   멤버변수(필드)는 private 으로 설정. -> 자기 클래스 안에서만 사용 가능
   멤버메소드는 public 으로 설정. -> 외부 클래스에서도 사용 가능
*/
public class MyTV {

    // TV의 상태 -> 멤버 변수 (필드: field)
    ...
    public void displayStatus(){
        ...
        System.out.println("----------------");
        System.out.println("전원 상태: " + isPowerOn);   // 동일 클래스 안의 멤버들을 사용 가능
