...
public class For01Main {
	...
	public static void main(String[] args) {
		...
		for(int i = 1; i <= 3; i++){
			System.out.println("안녕하세요 자바 " + i);
		}

		System.out.println();

		for(int i = 10; i > 0;  i--){  // 초기식에서 선언한 i 는 for block 의 지역변수
			System.out.print(i + ", ");
		}
		//System.out.println(i);   // i값은 for block 종료후 소멸.
		System.out.println();
		...
		System.out.printf("for 종료후 i:%d, j:%d\n", i, j);
