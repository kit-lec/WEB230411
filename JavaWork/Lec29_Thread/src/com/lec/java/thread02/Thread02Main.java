...
public class Thread02Main {
	...
	public static void main(String[] args) {
		...
		Runnable runnable2 = new MyRunnable("Hello, Spring!");
		Runnable runnable3 = new MyRunnable("웹개발1 종강!");
		...
		new Thread(new MyRunnable("수고하셨습니다!")).start();
...
/**
 * 응답시간이 많이 걸리는 작업을 주로 Thread 로 처리한다
 *   ex) 인터넷 통신, 파일작업, 데이터베이스
 * 
 *
 */
