...
public class Optional02Main {
	public static void main(String[] args) {
		...
		System.out.println(o1.get());  // Optional 의 내부 객체

		//o1 = Optional.of(null);   // of(value) 가 null 이면 NPE 발생
		...
		o2 = Optional.ofNullable(null);   // null 값 가능!
		...
		OptionalInt optInt = OptionalInt.of(10);   // boxing 발생안함!
		...
		System.out.println(optInt.getAsInt());  // unboxing 발생안함
