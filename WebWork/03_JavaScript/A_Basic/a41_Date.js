...
arr = [
    new Date(),
    // JS 는 month 값 0 ~ 11
    new Date(2023, 4, 18, 21, 33, 32),

    // 실제 해당월의 날짜(day)보다 큰 값이 입력되어도, 에러 없이 overflow 처리됨
    new Date(2018, 5, 35, 10, 33),
...
arr = [
    ...
    new Date("2023-04-01 09:05").toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true }),   // 9:05 AM
    new Date("2023-04-01 09:05").toLocaleString('en-US', { hour: '2-digit', minute: '2-digit', hour12: true }),   // 09:05 AM
